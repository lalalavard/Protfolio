...
import styles from "../components/home/Profile.module.scss";
        ...
        <div className="flex flex-col items-center justify-center min-h-screen mb-10 px-3 pb-10 ">
          <div className="grid grid-cols-1 sm:grid-cols-2 sm:mx-16">
            ...
            <div className="flex-1">
              ...
              <p>
                If you want to ask me for a job or want to work together on an
                OSS project, contact me.
              </p>
              <p className="py-2">I love travelling , movie and animation !</p>
              <div className="my-4 space-x-4">
                ...
                <span className="tooltip" data-tip="Mail">
                  <a
                    className="hover:text-accent transition-colors duration-300"
                    href="lavard:contact@lkay@gmail.com"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink="http://www.w3.org/1999/xlink"
